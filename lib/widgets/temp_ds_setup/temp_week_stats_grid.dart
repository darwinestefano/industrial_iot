...
class TemperaureweekStats extends StatefulWidget {
  @override
  _TemperaureweekStatsState createState() => _TemperaureweekStatsState();
}

class _TemperaureweekStatsState extends State<TemperaureweekStats> {
  @override
