...
class HumEnvRTStatsGrid extends StatefulWidget {
  @override
  _HumEnvRTStatsGridState createState() => _HumEnvRTStatsGridState();
}

class _HumEnvRTStatsGridState extends State<HumEnvRTStatsGrid> {
        ...
        children: <Widget>[
          ...
          Flexible(
            child: Row(
              children: <Widget>[
                _buildStatCard(
                  'Higher Trashhold Humidity',
                  '35',
                  white,
                  Colors.red,
                ),
                _buildStatCard(
                  'Lower Trashhold Humidity',
                  '20',
                  white,
                  Colors.blue,
                ),
