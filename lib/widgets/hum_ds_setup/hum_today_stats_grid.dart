...
class HumidityTodayStats extends StatefulWidget {
  @override
  _HumidityTodayStatsState createState() => _HumidityTodayStatsState();
}

class _HumidityTodayStatsState extends State<HumidityTodayStats> {
  @override
