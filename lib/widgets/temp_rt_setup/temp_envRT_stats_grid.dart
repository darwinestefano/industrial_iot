...
class TempEnvRTStatsGrid extends StatefulWidget {
  @override
  _EnvRTStatsGridState createState() => _EnvRTStatsGridState();
}

class _EnvRTStatsGridState extends State<TempEnvRTStatsGrid> {
        ...
        children: <Widget>[
          ...
          Flexible(
            child: Row(
              children: <Widget>[
                _buildStatCard(
                  'Higher Trashhold Temperature',
                  '35',
                  white,
                  Colors.red,
                ),
                _buildStatCard(
                  'Lower Trashhold Temperature',
                  '20',
                  white,
                  Colors.blue,
                ),
